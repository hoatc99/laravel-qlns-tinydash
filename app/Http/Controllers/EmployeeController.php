    ...
    public function store(Request $request)
    {
        ...
        try {
            $employee = Employee::create([
                ...
                'date_of_birth' => Carbon::createFromFormat('d/m/Y', $request->ngay_sinh)->format('Y-m-d'),
                'gender' => $request->gioi_tinh,
                'place_of_permanent' => $request->dia_chi,
                'identification_number' => $request->so_cccd,
                'date_of_issue' => Carbon::createFromFormat('d/m/Y', $request->ngay_cap)->format('Y-m-d'),
                'place_of_issue' => $request->noi_cap,
                'phone_number' => $request->so_dien_thoai,
                'email' => $request->email,
                'date_of_employment' => Carbon::createFromFormat('d/m/Y', $request->ngay_nhan_viec)->format('Y-m-d'),
